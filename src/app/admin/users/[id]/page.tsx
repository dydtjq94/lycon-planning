...
import { CONSULTATION_TYPES as CONSULTATION_TYPE_DATA, type ConsultationTypeData } from "@/lib/constants/consultationTypes";
...
// 상담 종류 정의 (공유 상수 + 아이콘)
interface ConsultationType extends ConsultationTypeData {
  icon: typeof ClipboardCheck;
}

const ICON_MAP: Record<string, typeof ClipboardCheck> = {
  "retirement-diagnosis": ClipboardCheck,
  "budget-consultation": Receipt,
  "investment-portfolio": BarChart3,
  "asset-review": Wallet,
  "pension-analysis": Landmark,
  "real-estate": Building,
  "tax-consultation": Calculator,
  "financial-decision": HelpCircle,
};

const CONSULTATION_TYPES: ConsultationType[] = CONSULTATION_TYPE_DATA.map(t => ({
  ...t,
  icon: ICON_MAP[t.id] || HelpCircle,
}));
