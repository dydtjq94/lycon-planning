          ...
          {(() => {
            ...
            return (
              <>
                ...
                <div className={styles.card}>
                  <div className={styles.costDetailHeader}>
                    <h3 className={styles.cardTitle}>여행/여가비</h3>
                    <div className={styles.costDetailTopRow}>
                      <div className={styles.costDetailOptions}>
                        {[
                          { value: "none" as const, label: "없음" },
                          { value: 0 as const, label: "검소" },
                          { value: 1 as const, label: "보통" },
                          { value: 2 as const, label: "여유" },
                        ].map((opt) => (
                          <button
                            key={String(opt.value)}
                            className={`${styles.costOptionBtn} ${costOptions.leisure === opt.value ? styles.active : ""}`}
                            onClick={() =>
                              setCostOptions((p) => ({
                                ...p,
                                leisure: opt.value as number | "none",
                              }))
                            }
                          >
                            {opt.label}
                ...
                <div className={styles.card}>
                  <div className={styles.costDetailHeader}>
                    <h3 className={styles.cardTitle}>소비재</h3>
                    <div className={styles.costDetailTopRow}>
                      <div className={styles.costDetailOptions}>
                        {[
                          { value: "none" as const, label: "없음" },
                          ...
                          <button
                            key={String(opt.value)}
                            className={`${styles.costOptionBtn} ${costOptions.consumerGoods === opt.value ? styles.active : ""}`}
                            onClick={() =>
                              setCostOptions((p) => ({
                                ...p,
                                consumerGoods: opt.value as number | "none",
                              }))
                            }
                          >
                            {opt.label}
                    ...
                    >
                      {formatBillion(
                        (costOptions.consumerGoods === "none"
                          ...
                          : additionalCosts.consumerGoods[
                              costOptions.consumerGoods as number
                            ]?.totalUntilLifeExpectancy || 0) / 10000,
                      )}
                      억
                    </span>
                  </div>
