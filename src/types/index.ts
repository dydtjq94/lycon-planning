...
export type CashFlowType =
  ...
  | "loan_disbursement" // 대출 실행 (현금 유입)
  | "deposit_payment" // 보증금 지출
...
export const EDUCATION_EXPENSE_BY_AGE: Record<number, {
  ...
  endAge?: number;   // 명시적 종료 나이 (없으면 다음 단계 시작 나이 - 1)
  isOneTime?: boolean; // 결혼자금 등 일시금
}> = {
  0: { label: '영아', normal: 150, premium: 1000, endAge: 2 },
  3: { label: '유아', normal: 200, premium: 1200, endAge: 3 },
  4: { label: '유치원', normal: 450, premium: 1800, endAge: 6 },
  7: { label: '초등학교', normal: 1000, premium: 2500, endAge: 12 },
  13: { label: '중학교', normal: 1500, premium: 4000, endAge: 15 },
  16: { label: '고등학교', normal: 2000, premium: 5000, endAge: 18 },
  19: { label: '대학교', normal: 3000, premium: 7000, endAge: 22 },
...
| 초등 7~12세 | 연 1,000만원 | 연 2,500만원 |
| 중학 13~15세 | 연 1,500만원 | 연 4,000만원 |
| 고등 16~18세 | 연 2,000만원 | 연 5,000만원 |
| 대학 19~22세 | 연 3,000만원 | 연 7,000만원 |
| 결혼자금 30세 | 1억원 | 5억원 |
